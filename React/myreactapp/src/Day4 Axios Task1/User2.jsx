  ...
  return (
    <div>
      ...
      onChange={e => setSearchTerm(e.target.value)}
       />
      <button className='btn btn-primary' style={{margin: '10px'}} onClick={handleSearch}>Search</button>
      <button className='btn btn-success' style={{margin: '10px'}} onClick={clearSearch}>Clear</button>
      </div>
